...
draft: false
lang: "en"
translationSlug: "guia-optimizacion-pagespeed"
---
...
Lighthouse will flag any stylesheet linked in the `<head>` of your page as **render-blocking**, since the browser must download and parse it before drawing anything. While preloading is great for third-party scripts, your primary stylesheets _should_ block rendering to prevent FOUC (Flash of Unstyled Content).
...
_Performance is a feature. Every millisecond you save is a user who stays._
