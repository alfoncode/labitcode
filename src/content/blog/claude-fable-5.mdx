...
| Plan | Access | Notes |
|------|--------|-------|
| **Pro** ($20/mo) | Included | Through June 22, then usage credits may apply |
| **Max** ($100/mo) | Included | Higher rate limits |
| **Team** ($25/user/mo) | Included | Shared rate limits |
| **Enterprise** | Included | Custom terms |
...
At $15/M output tokens, Fable 5 is priced at a premium — roughly **2x Opus 4.8** and **5x Sonnet 4.6**. But for tasks where Fable 5's superior reasoning eliminates multiple retry loops, the effective cost per completed task may actually be lower.

### The June 22 Deadline

Anthropic is offering Fable 5 with **unlimited usage on Pro/Max/Team/Enterprise plans until June 22, 2026**. After that date, usage credits may be required "until capacity expands." This suggests Anthropic is still scaling its inference infrastructure — the model is computationally expensive to run.
...
Sonnet 4.6 remains the pragmatic choice for most applications. At roughly 1/5 the output cost, it handles 80% of coding tasks adequately. Reserve Fable 5 for the 20% of tasks where superior reasoning actually changes the outcome.
...
- **Fable 5 is real, it's available now, and it's the most capable public model ever released.** Start experimenting today — especially if you're on a Pro or Max plan where it's included.
...
- **June 22 is an important date.** If you want to explore Fable 5's limits without worrying about usage credits, do it in the next two weeks.
