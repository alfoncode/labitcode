...
The irony is bitter: Anthropic built Fable 5's entire safety architecture to *prevent* exactly the kind of government intervention that just happened.

---

## 3. The Export Control Directive: What It Actually Says

The text of the directive — as quoted by Anthropic in its [official statement](https://www.anthropic.com/news/fable-mythos-access) — is remarkably broad:
...
Given this scope, Anthropic's hand was forced: to comply immediately, it had to disable the models for *everyone*.

### What's *Not* in the Directive
...
This concentration might make export controls *more* effective than they were in the 90s — or it might just concentrate the damage on a handful of US companies while the rest of the world catches up.
...
*Built with technical precision and artificial intelligence at labitcode.*
